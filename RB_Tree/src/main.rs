...
fn delete(rb_tree: RedBlackTree, data: u32) -> RedBlackTree {
...
fn delete_balance(replacement: RedBlackTree, org_color: NodeColor, parent: RedBlackTree, sibling: RedBlackTree, sibling_direction: Direction) -> RedBlackTree {
